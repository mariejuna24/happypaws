    ...
    <>
      ...
      <aside className={`admin-sidebar ${collapsed ? "admin-sidebar--collapsed" : ""}`}>
        ...
        <nav className="admin-sidebar__nav">
          ...
          <button
            className={`admin-nav-item ${isActive("stats") ? "active" : ""}`}
          ...
          {/* ✅ Ratings link */}
          <button
            className={`admin-nav-item ${isActive("ratings") ? "active" : ""}`}
            onClick={() => handleNav("ratings")}
          >
            <span className="admin-nav-item__icon">⭐</span>
          ...
          <button
            className={`admin-nav-item admin-nav-item--dropdown ${manageOpen ? "open" : ""}`}
          ...
          {manageOpen && (
            <div className="admin-nav-submenu">
              <button
                className={`admin-nav-subitem ${isActive("manage-users") ? "active" : ""}`}
                onClick={() => handleNav("manage-users")}
              >
                <span>👥</span> Users
              </button>
              {/* ✅ "Add Service" removed — now handled inside the Services page */}
            </div>
          )}
        </nav>
