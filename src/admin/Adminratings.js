  ...
  return (
    <div className="ar-page">
      ...
      <div className="ar-tabs">
        <button
          className={`ar-tab${activeTab === "overview" ? " ar-tab--active" : ""}`}
          onClick={() => setActiveTab("overview")}
        >
          📊 By Service
        </button>
        <button
          className={`ar-tab${activeTab === "reviews" ? " ar-tab--active" : ""}`}
                ...
                serviceStats.map((svc) => (
                  <div key={svc.id} className="ar-svc-card">
                    ...
                    <div className="ar-svc-card__top">
                      <img
                        src={svc.image || "https://placehold.co/60x60?text=🐾"}
                        alt={svc.title}
          ...
          {activeTab === "reviews" && (
            <div className="ar-reviews">
              ...
              <div className="ar-table-wrap">
                ...
                {filtered.length === 0 && (
                  <div className="ar-empty ar-empty--inline">
